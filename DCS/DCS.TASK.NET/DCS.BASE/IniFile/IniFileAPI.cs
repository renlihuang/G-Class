...
namespace DCS.BASE.IniFile
{
    public class IniFileAPI
    {
        ...
        public static string[] INIGetAllSectionNames(string iniFile)
        {
            ...
            uint bytesReturned = IniFileAPI.GetPrivateProfileSectionNames(pReturnedString, MAX_BUFFER, iniFile);
            if (bytesReturned != 0)
            {
                //读取指定内存的内容
        ...
        public static string[] INIGetAllItems(string iniFile, string section)
        {
            ...
            uint bytesReturned = IniFileAPI.GetPrivateProfileSection(section, pReturnedString, MAX_BUFFER, iniFile);
        ...
        /// <summary>
        /// 获取INI文件中指定节点(Section)中的值(key=value形式)
        /// </summary>
        /// <param name="iniFile"></param>
        /// <param name="section"></param>
        /// <returns></returns>
        public static Dictionary<string, string> INIGetAllItemsDict(string iniFile, string section) 
        {
            string[] ocvinidata = INIGetAllItems(iniFile, section);
            Dictionary<string, string> pairs = new Dictionary<string, string>();
            pairs.Clear();
            for (int i = 0; i < ocvinidata.Length; i++)
            {
                string[] temp = ocvinidata[i].Split('=');
        ...
        public static string[] INIGetAllItemKeys(string iniFile, string section)
        {
            ...
            uint bytesReturned = IniFileAPI.GetPrivateProfileString(section, null, null, chars, SIZE, iniFile);
        ...
        public static string INIGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            uint bytesReturned = IniFileAPI.GetPrivateProfileString(section, key, defaultValue, sb, SIZE, iniFile);
        ...
        public static bool INIWriteItems(string iniFile, string section, string items)
        {
            ...
            return IniFileAPI.WritePrivateProfileSection(section, items, iniFile);
        }
        ...
        public static bool INIWriteValue(string iniFile, string section, string key, string value)
        {
            ...
            return IniFileAPI.WritePrivateProfileString(section, key, value, iniFile);
        ...
        public static bool INIDeleteKey(string iniFile, string section, string key)
        {
            ...
            return IniFileAPI.WritePrivateProfileString(section, key, null, iniFile);
        }
        ...
        public static bool INIDeleteSection(string iniFile, string section)
        {
            ...
            return IniFileAPI.WritePrivateProfileString(section, null, null, iniFile);
        }
        ...
        public static bool INIEmptySection(string iniFile, string section)
        {
            ...
            return IniFileAPI.WritePrivateProfileSection(section, string.Empty, iniFile);
        }
