...
{
    internal class QueryMenusServiceImpl : IQueryMenusService, IAutoInject
    {
        private readonly IQueryMenusRepository queryRepository;

        public QueryMenusServiceImpl(IQueryMenusRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseMenusCondition condition = null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseMenusCondition condition = null, string field = null, string orderBy = null)
        {
