...
{
    internal class QueryMenuRightsServiceImpl : IQueryMenuRightsService, IAutoInject
    {
        private readonly IQueryMenuRightsRepository queryRepository;

        public QueryMenuRightsServiceImpl(IQueryMenuRightsRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseMenuRightsCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseMenuRightsCondition  condition=null, string field = null, string orderBy = null)
        {
