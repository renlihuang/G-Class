...
{
    internal class QueryRolesServiceImpl : IQueryRolesService, IAutoInject
    {
        private readonly IQueryRolesRepository queryRepository;

        public QueryRolesServiceImpl(IQueryRolesRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseRolesCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseRolesCondition  condition=null, string field = null, string orderBy = null)
        {
