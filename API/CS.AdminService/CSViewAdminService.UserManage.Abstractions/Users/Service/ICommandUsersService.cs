...
namespace CSViewAdminService.UserManage.Abstractions
{
    public interface ICommandUsersService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<HttpResponseResultModel<long>> InsertAsync(UsersEntity entity,bool isCommit = true);
        ...
        /// <returns></returns>
        Task<HttpResponseResultModel<bool>> InsertBatchAsync(List<UsersEntity> entityList,bool isCommit = true);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<HttpResponseResultModel<bool>> UpdateAsync(UsersEntity entity,bool isCommit = true);
        ...
        /// <returns></returns>
        Task<HttpResponseResultModel<bool>> UpdateBatchAsync(List<UsersEntity> entityList,bool isCommit = true);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<HttpResponseResultModel<bool>> SaveAsync(UsersEntity entity,bool isCommit = true);
        ...
        /// <returns></returns>
        Task<HttpResponseResultModel<bool>> UpsertDeleteAsync(List<UsersEntity> entities, List<long> oldIdList, bool isCommit = true);
