...
{
    internal class GCPDPRepositoryImpl : AbstractRepository<GCPDPEntity,BaseGCPDPCondition,long>,IQueryGCPDPRepository,ICommandGCPDPRepository<long>, IAutoInject
    {

	     public GCPDPRepositoryImpl (IScopeDBFactory scopeDBFactory) : base(scopeDBFactory)
        {
        ...
        public override Sql TrunConditionToSql(Sql sql,BaseGCPDPCondition condition)
        {
            if (condition != null)
            {
