...
{
    internal class CommandGCPrestackServiceImpl : ICommandGCPrestackService, IAutoInject
    {
        private readonly IDefaultUnitOfWorkV2<long,IEntity<long>, ICommandGCPrestackRepository<long>> unitOfWork;
		private readonly IQueryGCPrestackService  queryGCPrestackService;
 
        public CommandGCPrestackServiceImpl(IDefaultUnitOfWorkV2<long,IEntity<long>, ICommandGCPrestackRepository<long>> unitOfWork,IQueryGCPrestackService  queryGCPrestackService)
        {
        ...
        /// <returns></returns>
        public async Task<HttpResponseResultModel<long>> InsertAsync(GCPrestackEntity entity,bool isCommit = true)
        {
        ...
        /// <returns></returns>
        public async Task<HttpResponseResultModel<bool>> InsertBatchAsync(List<GCPrestackEntity> entityList,bool isCommit = true)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public async Task<HttpResponseResultModel<bool>> UpdateAsync(GCPrestackEntity entity,bool isCommit = true)
        {
            HttpResponseResultModel<bool> httpResponseResultModel = new HttpResponseResultModel<bool> { IsSuccess = false };
        ...
        /// <param name="entityList"></param>
        /// <returns></returns>
        public async Task<HttpResponseResultModel<bool>> UpdateBatchAsync(List<GCPrestackEntity> entityList,bool isCommit = true)
        {
            HttpResponseResultModel<bool> httpResponseResultModel = new HttpResponseResultModel<bool> { IsSuccess = false };
             foreach (var entity in entityList)
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public async Task<HttpResponseResultModel<bool>> SaveAsync(GCPrestackEntity entity, bool isCommit = true)
        {
            HttpResponseResultModel<bool> httpResponseResultModel = new HttpResponseResultModel<bool> { IsSuccess = false };
            var isExist = await queryGCPrestackService.ExistsAsync(entity.Id).ConfigureAwait(false);
            if (isExist)
            {
                unitOfWork.RegisterUpdate(entity);
            }
        ...
        /// <returns></returns>
        public virtual async Task<HttpResponseResultModel<bool>> UpsertDeleteAsync(List<GCPrestackEntity> entities, List<long> oldIdList, bool isCommit = true)
        {
            HttpResponseResultModel<bool> httpResponseResultModel = new HttpResponseResultModel<bool> { IsSuccess = false };
