...
{
    internal class QueryGCPrestackServiceImpl : IQueryGCPrestackService, IAutoInject
    {
        private readonly IQueryGCPrestackRepository queryRepository;

        public QueryGCPrestackServiceImpl(IQueryGCPrestackRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseGCPrestackCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseGCPrestackCondition  condition=null, string field = null, string orderBy = null)
        {
