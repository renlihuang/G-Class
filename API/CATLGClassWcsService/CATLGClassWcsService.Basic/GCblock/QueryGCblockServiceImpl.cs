...
{
    internal class QueryGCblockServiceImpl : IQueryGCblockService, IAutoInject
    {
        private readonly IQueryGCblockRepository queryRepository;

        public QueryGCblockServiceImpl(IQueryGCblockRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseGCblockCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseGCblockCondition  condition=null, string field = null, string orderBy = null)
        {
