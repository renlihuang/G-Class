...
{
    internal class QueryGCGlueServiceImpl : IQueryGCGlueService, IAutoInject
    {
        private readonly IQueryGCGlueRepository queryRepository;

        public QueryGCGlueServiceImpl(IQueryGCGlueRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseGCGlueCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseGCGlueCondition  condition=null, string field = null, string orderBy = null)
        {
