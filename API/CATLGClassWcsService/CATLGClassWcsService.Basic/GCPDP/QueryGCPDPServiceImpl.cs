...
{
    internal class QueryGCPDPServiceImpl : IQueryGCPDPService, IAutoInject
    {
        private readonly IQueryGCPDPRepository queryRepository;

        public QueryGCPDPServiceImpl(IQueryGCPDPRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseGCPDPCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseGCPDPCondition  condition=null, string field = null, string orderBy = null)
        {
