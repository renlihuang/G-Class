...
{
    internal class QueryOCVTESTServiceImpl : IQueryOCVTESTService, IAutoInject
    {
        private readonly IQueryOCVTESTRepository queryRepository;

        public QueryOCVTESTServiceImpl(IQueryOCVTESTRepository queryRepository)
        {
        ...
        /// <returns></returns>
        public async Task<QueryPagedResponseModel<T>> GetListPagedAsync<T>(int page, int size, BaseOCVTESTCondition condition=null, string field = null, string orderBy = null)
        {
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public async Task<List<T>> GetListAsync<T>(BaseOCVTESTCondition  condition=null, string field = null, string orderBy = null)
        {
