...
{
    internal class GCPrestackViewModel : DataProcess<GCPrestackEntity>
    {
        /// <summary>
        /// 参数管理名管理接口
        /// </summary>
        private readonly IGCPrestackService _petService;
        ...
        public GCPrestackViewModel(IGCPrestackService petService)
        {
        ...
        /// 参数明细命令
        /// </summary>
        public RelayCommand<GCPrestackEntity> ParamDetailCommand { get; private set; }
        ...
        {
            //查询数据
            var result = await _petService.GetGCPrestackAsync(pageInex, PageSize, new GCPrestackCondition()
            {
        ...
        protected override async void Save()
        {
            ...
            if (Mode == ActionMode.Add)
            {
                ...
                //添加数据
                result = await _petService.AddGCPrestackAAsync(Model);
            }
            else if (Mode == ActionMode.Edit)
            {
                result = await _petService.UpdateGCPrestackAAsync(Model.Id, Model);
            }
        ...
        protected override async void Delete(GCPrestackEntity model)
        {
            bool result = await _petService.DeteleGCPrestackAAsync(model.Id);
