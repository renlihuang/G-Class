...
{
    class ParamNameDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        private ParamNameViewModel _ViewModel;

        public ParamNameDlg(IParamNameService paramNameService)
        {
            _ViewModel = new ParamNameViewModel(paramNameService);
        }
