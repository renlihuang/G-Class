...
{
    public class ErrorLogDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        internal ErrorLogViewModel _ViewModel;

        public ErrorLogDlg(IErrorLogService paramNameService)
        {
            _ViewModel = new ErrorLogViewModel(paramNameService);
        }
