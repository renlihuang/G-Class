...
{
    public class PetMateriaDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        internal PetMateriaViewModel _ViewModel;

        public PetMateriaDlg(IPetMateriaService paramNameService)
        {
            _ViewModel = new PetMateriaViewModel(paramNameService);
        }
