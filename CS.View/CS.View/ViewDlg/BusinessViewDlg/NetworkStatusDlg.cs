...
{
    class NetworkStatusDlg: IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        private NetworkStatusViewModel _ViewModel;

        public NetworkStatusDlg(IDeviceNetworkInfoService deviceNetworkInfoService)
        {
            _ViewModel = new NetworkStatusViewModel(deviceNetworkInfoService);
        }
