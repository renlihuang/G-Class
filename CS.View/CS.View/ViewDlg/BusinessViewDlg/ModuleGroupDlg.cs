...
{
    class ModuleGroupDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        private ModuleGroupViewModel _ViewModel;

        public ModuleGroupDlg(IModuleGroupService moduleGroupService)
        {
            _ViewModel = new ModuleGroupViewModel(moduleGroupService);
        }
