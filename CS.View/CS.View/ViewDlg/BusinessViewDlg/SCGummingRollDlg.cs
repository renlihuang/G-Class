...
{
    public class SCGummingRollDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        internal SCGummingRollViewModel _ViewModel;

        public SCGummingRollDlg(ISCGummingRollService paramNameService)
        {
            _ViewModel = new SCGummingRollViewModel(paramNameService);
        }
