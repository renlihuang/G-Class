...
{
    class ModuleWeightDlg : IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        private ModuleWeightViewModel _ViewModel;

        public ModuleWeightDlg(IModuleWeightService  moduleWeightService)
        {
            _ViewModel = new ModuleWeightViewModel(moduleWeightService);
        }
