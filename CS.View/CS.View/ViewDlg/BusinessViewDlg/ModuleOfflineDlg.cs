...
{
    class ModuleOfflineDlg: IBaseModel
    {
        //当前窗口
        private UserControl _view;

        //当前窗口对应的viewModel
        private ModuleOfflineViewModel _ViewModel;

        public ModuleOfflineDlg(IModuleOfflineService moduleOfflineService)
        {
            _ViewModel = new ModuleOfflineViewModel(moduleOfflineService);
        }
